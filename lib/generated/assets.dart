...
class $AssetsImagesGen {
  ...
  final LottieGenImage empty = const LottieGenImage('assets/images/empty.json');
  final AssetGenImage listPurple = const AssetGenImage('assets/images/list_purple.png');
  final AssetGenImage logo = const AssetGenImage('assets/images/logo.png');
  final AssetGenImage media = const AssetGenImage('assets/images/media.png');
}

class $AssetsIconsGen {
  const $AssetsIconsGen();

  final AssetGenImage icon = const AssetGenImage('assets/icons/icon.jpg');
}
